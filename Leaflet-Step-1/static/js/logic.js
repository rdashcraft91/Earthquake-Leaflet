...
//   // Define a markerSize function that will give each earthquake a different radius based on its severity
...
function createMap(earthquakes) {
    ...
    for (var i = 0; i < earthquakes.length; i++) {
        ...
        }).bindPopup("<h3>" + "Magnitude: " + earthquakes.properties.mag +
        "</h3><hr><p>" + new Date(earthquakes.properties.time) + "</p>").addTo(myMap);
    }
